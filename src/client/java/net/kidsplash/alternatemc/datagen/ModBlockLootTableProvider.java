...
public class ModBlockLootTableProvider extends FabricBlockLootSubProvider {
    ...
    public void generate() {
        ...
        dropSelf(ModBlocks.Cobbled_Basalt);
        dropSelf(ModBlocks.Volcanic_Soil);
    }

    public LootTable.Builder multiDrop (final Block block, Item item, float minDrops, float maxDrops) {
